...
enum TagBroker with NumericIdentifiable {
  active("فعال", "Active", 101),
  inactive("غیرفعال", "Inactive", 102);

  const TagBroker(this.titleFa, this.titleEn, this.number);
...
enum TagBrokerProvider with NumericIdentifiable {
  avreen("آورین", "Avreen", 101);

  const TagBrokerProvider(this.titleFa, this.titleEn, this.number);
...
enum TagAgreementTemplate with NumericIdentifiable {
  terminal("دستگاه", "Terminal", 101);

  const TagAgreementTemplate(this.titleFa, this.titleEn, this.number);
...
enum TagAgreementBlock with NumericIdentifiable {
  intro("مقدمه", "Intro", 101),
  article("ماده", "Article", 102),
  articleCenter("ماده وسط چین", "Article Center", 103),
  clause("بند", "Clause", 104),
  sub("زیر بند", "Sub", 105),
  note("تبصره", "Note", 106),
  noteCenter("تبصره وسط چین", "Note Center", 107),
  pageBreak("صفحه جدید", "Page Break", 108);

  const TagAgreementBlock(this.titleFa, this.titleEn, this.number);
